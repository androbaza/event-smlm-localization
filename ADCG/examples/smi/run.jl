...
# LEONARDO removed the data downloading and reading since DATA NOT FOUND
#if !isdir("data")
#  print("Downloading data...")
#  # LEONARDO run(`./get-data.sh`)
#  run(`/Users/leonardo/Documents/GitHub/OLDSparseInverseProblems.jl/examples/smi/get-data.sh`)
#  run(`mkdir output`)
#  println("done.")
#end
